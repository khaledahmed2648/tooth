...
class DoctorHomeProfile extends StatelessWidget {
  const DoctorHomeProfile({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    Text('الاسم',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 23),),
                      ...
                      Text('البريد الالكتروني',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 23),),
                      SizedBox(height: 10,),
                      Container(
                        color: Color(0xffF9FAFB),
                        child: TextFormField(
