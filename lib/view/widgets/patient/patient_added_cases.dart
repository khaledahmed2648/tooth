...
class PatientAddedCases extends StatelessWidget {
  const PatientAddedCases({Key? key}) : super(key: key);
      ...
      child: Column(
        children: [
          Align(
              ...
              .marginOnly(right: 15),
          GetBuilder<HomePatientController>(builder: (controller) {
